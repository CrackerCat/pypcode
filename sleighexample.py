...
cppyy.include('src/loadimage.hh')
cppyy.include('src/sleigh.hh')
cppyy.include('src/emulate.hh')

log.debug('Loading Library')
cppyy.load_library('libsla.o')
...
#
log.debug('creating Pcode helper class')
cppyy.cppdef('''
...
def main():
  ...
  docstorage.registerTag(docstorage.openDocument(sleighfilename).getRoot())
